...
<body>
 ...
 <div class="p-4 sm:ml-64">
   ...
   <div class="px-2  block py-4">
      <p class="mb-4 text-lg font-medium text-black">Detail Buku</p>
   </div>
    ...
    <section id="home">
      ...
      <!-- <div class="container lg:px-24"> -->
        <div class="flex flex-wrap justify-center">
          ...
          <div class="px-4 lg:pt-20 items-center lg:w-1/2">
                <div class="w-40 lg:w-56 mx-auto bg-black rounded-xl shadow-lg overflow-hidden mb-5 lg:mb-10">
                    <img src="../img/<?= $buku["gambar"]; ?>" alt="Sampul Buku" class="w-full py-2 px-2 lg:py-4 lg:px-4">
                </div>
            </div>
            <div class="w-full lg:pt-6 px-6 lg:px-4 self-start lg:w-1/2 bg-white">
              <div>
              ...
              <h3 href="#" class="block mb-0 lg:mb-2 font-semibold text-base lg:text-xl text-dark"><?= $buku["rak_buku"]; ?></h3>
              

              <?= $status_buku ?>


              <div class="table w-full text-md font-medium text-neutral-900 mb-6 ">
